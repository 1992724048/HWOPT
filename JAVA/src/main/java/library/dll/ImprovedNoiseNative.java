...
public interface ImprovedNoiseNative extends AutoCloseable {

	class Holder {
		static final ImprovedNoiseNative INSTANCE = FFMFactory.load(ImprovedNoiseNative.class);
	}

	static ImprovedNoiseNative instance() {
