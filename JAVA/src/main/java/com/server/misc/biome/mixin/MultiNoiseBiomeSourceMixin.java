...
import com.server.misc.biome.BiomeFinder;
...
public abstract class MultiNoiseBiomeSourceMixin extends BiomeSource {
	@Override
	public Pair<BlockPos, Holder<Biome>> findClosestBiome3d(@NotNull BlockPos pos, int radius, int horizontalStep, int verticalStep, @NonNull Predicate<Holder<Biome>> biomePredicate, Climate.@NonNull Sampler sampler, @NonNull LevelReader level) {
